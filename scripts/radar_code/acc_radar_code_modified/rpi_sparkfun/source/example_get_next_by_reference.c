...
/**
 * @brief Example that shows how to use the alternative get_next function, get_next_by_reference
 *
 * The example uses Envelope as example, but the procedure is the same for the
 * rest of the services/detectors.
 *
