 ...
 */
extern acc_app_integration_thread_id_t acc_os_get_thread_id(void);
 ...
 */
extern uint32_t acc_os_get_time(void);
 ...
 */
extern acc_app_integration_mutex_t acc_os_mutex_create(void);
 ...
 */
extern void acc_os_mutex_lock(acc_app_integration_mutex_t mutex);
 ...
 */
extern void acc_os_mutex_unlock(acc_app_integration_mutex_t mutex);
 ...
 */
extern void acc_os_mutex_destroy(acc_app_integration_mutex_t mutex);
 ...
 */
extern acc_app_integration_thread_handle_t acc_os_thread_create(void (*func)(void *param), void *param, const char *name);
 ...
 */
extern void acc_os_thread_cleanup(acc_app_integration_thread_handle_t thread);
 ...
 */
extern acc_app_integration_semaphore_t acc_os_semaphore_create(void);
 ...
 */
extern bool acc_os_semaphore_wait(acc_app_integration_semaphore_t sem, uint16_t timeout_ms);
 ...
 */
extern void acc_os_semaphore_signal(acc_app_integration_semaphore_t sem);
 ...
 * @param[in]  sem A pointer to the semaphore to signal
 */
extern void acc_os_semaphore_signal_from_interrupt(acc_app_integration_semaphore_t sem);
 ...
 */
extern void acc_os_semaphore_destroy(acc_app_integration_semaphore_t sem);
