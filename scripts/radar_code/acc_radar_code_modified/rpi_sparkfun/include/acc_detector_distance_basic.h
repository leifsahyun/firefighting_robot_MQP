 ...
 *
 * @param[in] sensor_id The sensor where the detector will get its result from
 ...
 */
extern acc_detector_distance_basic_handle_t acc_detector_distance_basic_create(acc_sensor_id_t sensor_id, float range_start, float range_length);
