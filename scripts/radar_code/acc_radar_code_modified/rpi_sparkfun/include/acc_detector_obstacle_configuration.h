 ...
 * @return The gain
 */
extern float acc_detector_obstacle_configuration_get_gain(acc_detector_obstacle_configuration_t obstacle_configuration);
...
/**
 * @brief Set the scale factor used in the background estimation
 *
 * @param[in] obstacle_configuration The configuration that the setting shall be applied to
 * @param background_scale The value to be used for background estimation
 */
...
/**
 * @brief Get the scale factor used in the background estimation
 *
 * @param[in] obstacle_configuration The configuration
 *
 ...
 */
extern uint16_t acc_detector_obstacle_configuration_get_max_number_of_obstacles(acc_detector_obstacle_configuration_t obstacle_configuration);
